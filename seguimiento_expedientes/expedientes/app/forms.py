...
class TaskForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'task': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Escriba aca la Tarea' }),
        }
...
class FileForm(forms.ModelForm):
    ...
    class Meta:
        model = File
        fields=['file_name','formato','store_number','proj_type']

        labels = {
            'file_name': 'Proyecto',
            'formato': 'Formato',
            'store_number': 'Numero de Tienda',
            'proj_type': 'Tipo de Proyecto',
        }

        widgets = {
            'file_name': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Escriba el nombre del proyecto' }),
            'formato': forms.Select(attrs={'class': 'form-control', 'placeholder': 'Seleccione el Formato'}),
            'store_number': forms.NumberInput(),
            'proj_type': forms.Select(attrs={'class': 'form-control', 'placeholder': 'Seleccione el tipo de proyecto'}),
        }